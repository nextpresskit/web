...
export function BlogAuthorsTableAdmin({
	...
	return (
		<div className="flex min-w-0 w-full max-w-full flex-col justify-start gap-6 pb-6">
			<div className="flex items-center justify-between px-4 pb-4 lg:px-6">
				<div className="flex items-center gap-2">
					<Button variant="outline" size="sm">
						<Plus />
						<span className="hidden lg:inline">Invite author</span>
					</Button>
				</div>
				<div className="flex items-center gap-2">
